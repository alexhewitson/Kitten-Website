...
echo <<<_END
	<div class="container">
		<form action = "account_create_employee.php" method = "post" style="text-align: center;">
			...
			<input type="text" class="box" name = "position" required><br><br>
...
if(isset($_POST['username']) &&
	...
	isset($_POST['position'])) {
		...
		$position = mysql_entities_fix_string($conn, 'position');
		...
		// insert into employee
 		$query="INSERT INTO employee (first_name, last_name, position, USER_ID) VALUES ".
			"('$first','$last','$position', '$user_id')";
		$result=$conn->query($query);
		if (!$result) {
